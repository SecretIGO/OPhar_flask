...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 21, 2023 at 02:36 AM
...
CREATE TABLE IF NOT EXISTS `orders` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_package` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `orders` (`id`, `id_package`) VALUES
(1, '14fe1534-e122-4a4c-a79a-5f46ade18a65'),
(2, 'edae3107-b1db-4996-9bd1-7ef8b19f1974'),
(3, '32b7e4c0-1e3b-4b6e-a452-590df8f978b1'),
(4, '227eb53e-1db2-4b36-af96-978edd44f932');
...
CREATE TABLE IF NOT EXISTS `order_package` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_package_item` (`id_item`),
  KEY `fk_package_user` (`id_user`),
  KEY `fk_package_uuid` (`id_package`)
...
INSERT INTO `order_package` (`id`, `id_user`, `id_item`, `quantity`, `id_package`) VALUES
(2, 1, 41, 11, 1),
(3, 1, 48, 5, 1),
(4, 1, 43, 4, 1),
(5, 3, 46, 5, 2),
...
ALTER TABLE `order_package`
  ADD CONSTRAINT `fk_package_item` FOREIGN KEY (`id_item`) REFERENCES `items` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `fk_package_user` FOREIGN KEY (`id_user`) REFERENCES `user_customer` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `fk_package_uuid` FOREIGN KEY (`id_package`) REFERENCES `orders` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
